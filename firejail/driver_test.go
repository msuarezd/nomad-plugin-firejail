...
func TestFirejailDriver_Fingerprint_NonLinux(t *testing.T) {
	if !testutil.IsCI() {
		t.Parallel()
	}
	...
	d := NewFirejailDriver(ctx, testlog.HCLogger(t))
...
func TestFirejailDriver_Fingerprint(t *testing.T) {
	t.Parallel()
	require := require.New(t)
...
func TestFirejailDriver_StartWait(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
...
func TestFirejailDriver_StartWaitStopKill(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
...
func TestFirejailDriver_StartWaitRecover(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
	...
	d := NewFirejailDriver(dctx, testlog.HCLogger(t))
	harness := dtestutil.NewDriverHarness(t, d)
	task := &drivers.TaskConfig{
		ID:        uuid.Generate(),
		Name:      "test",
...
// TestFirejailDriver_DestroyKillsAll asserts that when TaskDestroy is called all
// task processes are cleaned up.
func TestFirejailDriver_DestroyKillsAll(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
...
func TestFirejailDriver_Stats(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
...
func TestFirejailDriver_Start_Wait_AllocDir(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
...
func TestFirejailDriver_User(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
...
// TestFirejailDriver_HandlerExec ensures the exec driver's handle properly
// executes commands inside the container.
func TestFirejailDriver_HandlerExec(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
...
func TestFirejailDriver_DevicesAndMounts(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
...
func TestFirejailDriver_NoPivotRoot(t *testing.T) {
	t.Parallel()
	require := require.New(t)
	ctestutils.ExecCompatible(t)
